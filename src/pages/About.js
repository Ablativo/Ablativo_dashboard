  ...
  function TeamCard(props) {
    return (
      <Card variant="outlined">
        ...
        <CardActions>
          <Button className={classes.link} href={props.link} size="small" color="primary">
      ...
      <Grid container spacing={3}>
        <Grid item xs={12}>
          <Paper className={classes.paper}>
            ...
            <Typography>
              {" "}
              Museums, the house of muses, some people love them, but for some,
              it is no more than a boring collection of lifeless things.
              However, here comes our application, Ablativo, intending to bring
              also those least interested people to the wonderful world of
              museums.
            </Typography>
            <br />
            <Typography>
              ...
              engineering in computer science at "La Sapienza" University of
              Rome, and this project has been developed as part of the Internet
              of Things 2019-2020 course. Here you can find the links to our
              LinkedIn profiles.
            </Typography>
            <br />
